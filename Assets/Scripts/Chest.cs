...
public class Chest : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        promptGO = new GameObject("ChestPrompt", typeof(Text));
    ...
    void Refresh()
    {
        ...
        nameText.text = "<color=#" + ItemRarity.HexColor(rarity) + ">" + displayName + (amount > 1 ? " x" + amount : "") + "</color>";

        string body = definition != null ? definition.Description : "";
        body = (string.IsNullOrEmpty(body) ? "" : body + "\n") + ItemRarity.Name(rarity);
