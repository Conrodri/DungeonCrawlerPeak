...
public class StatsUI : MonoBehaviour
{
    ...
    void Refresh()
    {
        if (stats == null || texts == null) return;
        texts[0].text = Labels[0] + ": " + stats.constitution;
        texts[1].text = Labels[1] + ": " + stats.force;
        texts[2].text = Labels[2] + ": " + stats.dexterite;
        texts[3].text = Labels[3] + ": " + stats.intelligence;
        texts[4].text = Labels[4] + ": " + stats.vitesse;
        texts[5].text = Labels[5] + ": " + stats.charisme;
    }
}
